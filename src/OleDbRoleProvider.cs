  ...
  public sealed class OleDbRoleProvider: RoleProvider
  {
    ...
    public override void Initialize(string name, NameValueCollection config)
    {
      ...
      if (String.IsNullOrEmpty(config["description"]))
      {
        ...
        config.Add("description", "OleDb Role provider");
      }
    ...
    public override void AddUsersToRoles(string[]  usernames, string[] rolenames)
    {
      ...
      OleDbCommand cmd = new OleDbCommand("INSERT INTO [" + usersInRolesTable + "]"  +
    ...
    { 
      ...
      OleDbConnection conn = new OleDbConnection(connectionString);
      OleDbCommand cmd = new OleDbCommand("INSERT INTO [" + rolesTable + "]"  +
    ...
    public override bool DeleteRole(string rolename, bool throwOnPopulatedRole)
    {
      ...
      OleDbConnection conn = new OleDbConnection(connectionString);
      OleDbCommand cmd = new OleDbCommand("DELETE FROM [" + rolesTable + "]"  +
      ...
      OleDbCommand cmd2 = new OleDbCommand("DELETE FROM [" + usersInRolesTable + "]"  +
              " WHERE Rolename = ? AND ApplicationName = ?", conn);
    ...
    public override string[] GetAllRoles()
    {
      ...
      OleDbConnection conn = new OleDbConnection(connectionString);
      OleDbCommand cmd = new OleDbCommand("SELECT Rolename FROM [" + rolesTable + "]"  +
    ...
    public override string[] GetRolesForUser(string username)
    {
      ...
      OleDbConnection conn = new OleDbConnection(connectionString);
      OleDbCommand cmd = new OleDbCommand("SELECT Rolename FROM [" + usersInRolesTable + "]"  +
    ...
    public override string[] GetUsersInRole(string rolename)
    {
      ...
      OleDbConnection conn = new OleDbConnection(connectionString);
      OleDbCommand cmd = new OleDbCommand("SELECT Username FROM [" + usersInRolesTable + "]"  +
                " WHERE Rolename = ? AND ApplicationName = ?", conn);
    ...
    public override bool IsUserInRole(string username, string rolename)
    {
      ...
      OleDbConnection conn = new OleDbConnection(connectionString);
      OleDbCommand cmd = new OleDbCommand("SELECT COUNT(*) FROM [" + usersInRolesTable + "]"  +
    ...
    public override void RemoveUsersFromRoles(string[] usernames, string[] rolenames)
    {
      ...
      OleDbConnection conn = new OleDbConnection(connectionString);
      OleDbCommand cmd = new OleDbCommand("DELETE FROM [" + usersInRolesTable + "]"  +
              " WHERE Username = ? AND Rolename = ? AND ApplicationName = ?", conn);
    ...
    public override bool RoleExists(string rolename)
    {
      ...
      OleDbConnection conn = new OleDbConnection(connectionString);
      OleDbCommand cmd = new OleDbCommand("SELECT COUNT(*) FROM [" + rolesTable + "]"  +
                " WHERE Rolename = ? AND ApplicationName = ?", conn);
